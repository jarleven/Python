...
# Code have been modified with pull-up resistors, max/min value and option to loop the value returned by the encoder
...
class Encoder(object):
    ...
    """
    def __init__(self, A, B, PUP, MAX, MIN, LOOP):
